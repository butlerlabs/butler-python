...
class UploadDocumentResponseDto(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, filename, document_id, *args, **kwargs):  # noqa: E501
        """UploadDocumentResponseDto - a model defined in OpenAPI
