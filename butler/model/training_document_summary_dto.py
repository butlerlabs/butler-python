...
class TrainingDocumentSummaryDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status': (ModelTrainingDocumentStatus,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, document_id, status, size, *args, **kwargs):  # noqa: E501
        """TrainingDocumentSummaryDto - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_reason (str): Reason for why the document failed. [optional]  # noqa: E501
        """
