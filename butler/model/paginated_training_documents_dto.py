...
def lazy_import():
    ...
    globals()['TrainingDocumentSummaryDto'] = TrainingDocumentSummaryDto


class PaginatedTrainingDocumentsDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([TrainingDocumentSummaryDto],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, has_next, has_previous, total_count, items, *args, **kwargs):  # noqa: E501
        """PaginatedTrainingDocumentsDto - a model defined in OpenAPI
        ...
        Args:
            ...
            items ([TrainingDocumentSummaryDto]): Array of training documents for this model
