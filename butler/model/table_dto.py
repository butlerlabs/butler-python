...
def lazy_import():
    ...
    globals()['ColumnDto'] = ColumnDto


class TableDto(ModelNormal):
    ...
    def __init__(self, name, columns, *args, **kwargs):  # noqa: E501
        """TableDto - a model defined in OpenAPI

        Args:
            name (str): The name of the table
            columns ([ColumnDto]): The columns of the table
