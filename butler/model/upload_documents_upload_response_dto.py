...
def lazy_import():
    ...
    globals()['UploadDocumentResponseDto'] = UploadDocumentResponseDto


class UploadDocumentsUploadResponseDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'documents': ([UploadDocumentResponseDto],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, upload_id, documents, *args, **kwargs):  # noqa: E501
        """UploadDocumentsUploadResponseDto - a model defined in OpenAPI

        Args:
            upload_id (str): The ID of the newly created upload.
            documents ([UploadDocumentResponseDto]): An array of info about the documents uploaded.
