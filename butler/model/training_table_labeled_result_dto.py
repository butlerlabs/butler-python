...
class TrainingTableLabeledResultDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'rows': ([TrainingRowLabeledResultDto],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, type, columns, rows, *args, **kwargs):  # noqa: E501
        """TrainingTableLabeledResultDto - a model defined in OpenAPI
        ...
        Args:
            ...
            rows ([TrainingRowLabeledResultDto]): The rows and labeled results for this table.
