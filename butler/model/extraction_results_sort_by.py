...
class ExtractionResultsSortBy(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ExtractionResultsSortBy - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "DocumentId", must be one of ["DocumentId", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "DocumentId", must be one of ["DocumentId", ]  # noqa: E501
