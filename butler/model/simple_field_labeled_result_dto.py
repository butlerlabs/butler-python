...
class SimpleFieldLabeledResultDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'blocks': ([BlockResultDto],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, type, blocks, *args, **kwargs):  # noqa: E501
        """SimpleFieldLabeledResultDto - a model defined in OpenAPI

        Args:
            id (str): The unique id of the field.
            name (str): The name of the field.
            type (ModelFieldType):
            blocks ([BlockResultDto]): The blocks for this field.
