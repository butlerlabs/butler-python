...
class TrainingDocumentResultDto(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, model_id, document_id, file_name, temp_doc_url, mime_type, word_blocks, annotations, *args, **kwargs):  # noqa: E501
        """TrainingDocumentResultDto - a model defined in OpenAPI
