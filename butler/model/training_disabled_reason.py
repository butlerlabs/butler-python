...
class TrainingDisabledReason(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TrainingDisabledReason - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "NotEnoughDocumentsLabeled", must be one of ["NotEnoughDocumentsLabeled", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "NotEnoughDocumentsLabeled", must be one of ["NotEnoughDocumentsLabeled", ]  # noqa: E501
        ...
        if 'value' in kwargs:
            ...
            value = "NotEnoughDocumentsLabeled"
