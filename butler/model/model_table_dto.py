...
def lazy_import():
    ...
    globals()['ModelColumnDto'] = ModelColumnDto
    globals()['ModelFieldType'] = ModelFieldType


class ModelTableDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'columns': ([ModelColumnDto],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, name, id, columns, *args, **kwargs):  # noqa: E501
        """ModelTableDto - a model defined in OpenAPI

        Args:
            type (ModelFieldType):
            name (str): The name for the new field
            id (str): The unique id of this table.
            columns ([ModelColumnDto]): The columns fields for this table
