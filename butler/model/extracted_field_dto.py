...
class ExtractedFieldDto(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, field_name, value, confidence_score, *args, **kwargs):  # noqa: E501
        """ExtractedFieldDto - a model defined in OpenAPI
