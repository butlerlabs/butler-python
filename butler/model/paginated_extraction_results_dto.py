...
def lazy_import():
    ...
    globals()['ExtractionResultsDto'] = ExtractionResultsDto


class PaginatedExtractionResultsDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([ExtractionResultsDto],),  # noqa: E501
        }
    ...
    def __init__(self, has_next, has_previous, total_count, items, *args, **kwargs):  # noqa: E501
        """PaginatedExtractionResultsDto - a model defined in OpenAPI
        ...
        Args:
            ...
            items ([ExtractionResultsDto]): Page of extraction results
