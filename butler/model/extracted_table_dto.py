...
class ExtractedTableDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'rows': ([ExtractedTableRowDto],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, table_name, rows, confidence_score, *args, **kwargs):  # noqa: E501
        """ExtractedTableDto - a model defined in OpenAPI

        Args:
            table_name (str):
            rows ([ExtractedTableRowDto]):
