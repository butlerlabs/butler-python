...
class ExtractedTableCellDto(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, column_name, value, confidence_score, *args, **kwargs):  # noqa: E501
        """ExtractedTableCellDto - a model defined in OpenAPI
