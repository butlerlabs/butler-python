...
def lazy_import():
    ...
    globals()['AppRunStatus'] = AppRunStatus


class AppRunStatusDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'app_run_id': (str,),  # noqa: E501
            'status': (AppRunStatus,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_run_id, status, *args, **kwargs):  # noqa: E501
        """AppRunStatusDto - a model defined in OpenAPI
