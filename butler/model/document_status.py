...
class DocumentStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["UploadingFile", "DetectingText", "ExtractingData", "WaitingForButlerOpsReview", "WaitingForUserReview", "Completed", "Failed", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["UploadingFile", "DetectingText", "ExtractingData", "WaitingForButlerOpsReview", "WaitingForUserReview", "Completed", "Failed", ]  # noqa: E501
