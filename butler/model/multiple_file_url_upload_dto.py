...
class MultipleFileUrlUploadDto(ModelNormal):
    ...
    def __init__(self, files, *args, **kwargs):  # noqa: E501
        """MultipleFileUrlUploadDto - a model defined in OpenAPI

        Args:
            files ([UrlUploadDto]): List of files to upload
