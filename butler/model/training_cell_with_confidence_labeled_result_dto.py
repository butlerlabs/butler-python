...
class TrainingCellWithConfidenceLabeledResultDto(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, column_id, confidence_score, blocks, *args, **kwargs):  # noqa: E501
        """TrainingCellWithConfidenceLabeledResultDto - a model defined in OpenAPI

        Args:
            column_id (str): The id of the column for this cell.
            confidence_score (DocExConfidence):
            blocks ([BlockDto]): The blocks for this cell.
        ...
        Keyword Args:
            ...
            region (object): The region for this cell.. [optional]  # noqa: E501
            value (str): The text value for this cell.. [optional]  # noqa: E501
        """
