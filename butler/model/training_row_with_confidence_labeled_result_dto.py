...
class TrainingRowWithConfidenceLabeledResultDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'cells': ([TrainingCellWithConfidenceLabeledResultDto],),  # noqa: E501
        }
    ...
    def __init__(self, id, cells, *args, **kwargs):  # noqa: E501
        """TrainingRowWithConfidenceLabeledResultDto - a model defined in OpenAPI

        Args:
            id (str): The unique id of this row.
            cells ([TrainingCellWithConfidenceLabeledResultDto]): The labeled results for this cell.
