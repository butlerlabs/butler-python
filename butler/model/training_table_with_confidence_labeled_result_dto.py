...
class TrainingTableWithConfidenceLabeledResultDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'type': (ModelFieldType,),  # noqa: E501
            'confidence_score': (DocExConfidence,),  # noqa: E501
            'columns': ([TrainingColumnDto],),  # noqa: E501
            'rows': ([TrainingRowWithConfidenceLabeledResultDto],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, type, confidence_score, columns, rows, *args, **kwargs):  # noqa: E501
        """TrainingTableWithConfidenceLabeledResultDto - a model defined in OpenAPI
        ...
        Args:
            ...
            columns ([TrainingColumnDto]): The columns for this table.
            rows ([TrainingRowWithConfidenceLabeledResultDto]): The rows and labeled results for this table.
