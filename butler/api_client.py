...
from butler import rest
from butler.configuration import Configuration
from butler.exceptions import ApiTypeError, ApiValueError, ApiException
from butler.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_app_run_status  # this is an instance of the class Endpoint
        api_instance.get_app_run_status()  # this invokes api_instance.get_app_run_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_app_run_status.callable or self.callable in this class
